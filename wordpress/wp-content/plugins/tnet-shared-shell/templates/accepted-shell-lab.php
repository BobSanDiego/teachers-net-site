        ...
        <header class="tnet-jobs-shell-lab-header" data-tnet-shell-header>
          <div class="tnet-jobs-shell-lab-header-inner">
            ...
            <div class="tnet-jobs-shell-lab-navbar-right">
                ...
                <div class="tnet-jobs-shell-lab-nav-menu tnet-jobs-shell-lab-chatboards-menu<?php echo $active_destination === 'chatboards' ? ' is-current' : ''; ?>">
                  ...
                  <div id="tnet-jobs-shell-chatboards-navigation" class="tnet-jobs-shell-lab-popover tnet-jobs-shell-lab-chatboards-popover">
                    <section class="tnet-jobs-shell-lab-chatboards-section">
                      ...
                      <a href="<?php echo esc_url($urls["chatboards"]); ?>" class="tnet-jobs-shell-lab-chatboards-item tnet-jobs-shell-lab-lessonplans-taxonomy-parent tnet-jobs-shell-lab-lessonplans-taxonomy-parent--subject"><span class="tnet-jobs-shell-lab-chatboards-icon" aria-hidden="true"><?php self::render_parity_product_icon('book'); ?></span><span class="tnet-jobs-shell-lab-lessonplans-parent-label">Subject Area Chatboards</span></a>
                ...
                <div class="tnet-jobs-shell-lab-nav-menu tnet-jobs-shell-lab-lessonplans-menu<?php echo $active_destination === 'lesson-plans' ? ' is-current' : ''; ?>">
                  ...
                  <div id="tnet-jobs-shell-lessonplans-navigation" class="tnet-jobs-shell-lab-popover tnet-jobs-shell-lab-lessonplans-popover">
                    ...
                    <section class="tnet-jobs-shell-lab-lessonplans-section">
                      ...
                      <button type="button" class="tnet-jobs-shell-lab-lessonplans-item tnet-jobs-shell-lab-lessonplans-taxonomy-parent tnet-jobs-shell-lab-lessonplans-taxonomy-parent--subject" data-lesson-accordion-trigger="subject" aria-controls="tnet-jobs-shell-lab-subject-taxonomy" aria-expanded="false"><span class="tnet-jobs-shell-lab-chatboards-icon"><?php self::render_parity_product_icon('book'); ?></span><span class="tnet-jobs-shell-lab-lessonplans-parent-label">Subject Area</span></button>
              ...
              <?php if (!$guest_state || !$suppress_anonymous_actions) : ?><div class="tnet-jobs-shell-lab-account-area<?php echo $guest_state ? ' tnet-jobs-shell-lab-anonymous-account-area' : ''; ?>">
                <?php if ($guest_state && !$suppress_anonymous_actions) : ?>
              ...
              <div class="tnet-jobs-shell-lab-mobile-menu">
                ...
                <div id="tnet-jobs-shell-compact-navigation" class="tnet-jobs-shell-lab-popover tnet-jobs-shell-lab-compact-navigation">
                  ...
                  <section class="tnet-jobs-shell-lab-compact-panel is-active" data-compact-panel="root" data-compact-flow="<?php echo $shell_has_employer_access ? 'employer' : 'jobseeker'; ?>">
                    <?php if ($guest_state && !$suppress_anonymous_actions) : ?><div class="tnet-jobs-shell-lab-compact-auth"><a href="<?php echo esc_url($login_url); ?>"><?php echo esc_html__('Log In', 'tnet-shared-shell'); ?></a><a href="<?php echo esc_url($signup_url); ?>"><?php echo esc_html__('Sign Up', 'tnet-shared-shell'); ?></a></div><?php endif; ?>
                  ...
                  <section class="tnet-jobs-shell-lab-compact-panel" data-compact-panel="chatboards" hidden>
                    ...
                    <a href="<?php echo esc_url($urls["chatboards"]); ?>" class="tnet-jobs-shell-lab-chatboards-item tnet-jobs-shell-lab-compact-link tnet-jobs-shell-lab-compact-link--subject"><span class="tnet-jobs-shell-lab-chatboards-icon" aria-hidden="true"><?php self::render_parity_product_icon('book'); ?></span><span>Subject Areas</span></a>
