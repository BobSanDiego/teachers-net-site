        ...
        <header class="tnet-shared-shell__header" data-tnet-shell-header>
          <div class="tnet-shared-shell__header-inner">
            ...
            <div class="tnet-shared-shell__utilities">
              ...
              <?php if ($account) : $account_id = 'tnet-shared-shell-account'; ?><div class="tnet-shared-shell__menu" data-tnet-shell-menu>
                <button type="button" class="tnet-shared-shell__utility tnet-shared-shell__account-trigger" data-tnet-shell-disclosure aria-expanded="false" aria-controls="<?php echo esc_attr($account_id); ?>" aria-haspopup="true" aria-label="<?php echo esc_attr((string) ($account['label'] ?? $account['name'] ?? 'Account')); ?>"><span class="tnet-shared-shell__avatar" aria-hidden="true"><?php echo esc_html(mb_strtoupper(mb_substr((string) ($account['name'] ?? $account['label'] ?? 'A'), 0, 1))); ?></span><span class="tnet-shared-shell__account-copy"><strong><?php echo esc_html((string) ($account['label'] ?? $account['name'] ?? 'Account')); ?></strong><span><?php echo esc_html((string) ($account['name'] ?? 'Account')); ?></span></span><span class="tnet-shared-shell__caret" aria-hidden="true"></span></button>
                <div id="<?php echo esc_attr($account_id); ?>" class="tnet-shared-shell__panel tnet-shared-shell__account-panel" data-tnet-shell-panel hidden>
                  <?php if (!empty($account['identity'])) : $identity = (array) $account['identity']; ?><div class="tnet-shared-shell__account-identity"><span class="tnet-shared-shell__avatar" aria-hidden="true"><?php echo esc_html(mb_strtoupper(mb_substr((string) ($identity['name'] ?? $account['name'] ?? 'A'), 0, 1))); ?></span><div><strong><?php echo esc_html((string) ($identity['name'] ?? '')); ?></strong><?php if (!empty($identity['email'])) : ?><span><?php echo esc_html((string) $identity['email']); ?></span><?php endif; ?><?php if (!empty($identity['descriptor'])) : ?><span><?php echo esc_html((string) $identity['descriptor']); ?></span><?php endif; ?></div></div><?php endif; ?>
