...
final class TNet_Community_Landing_Controller {
    ...
    public static function render(): void {
        ...
        TNet_Community_Shared_Shell::render($name, static function () use ($rows, $name, $new, $landing, $community): void {
            ...
            echo '<div class="c3-community-layout">' . TNet_Community_Rail_Parent_Service::render($community) . '<main class="c3-community-main"><section class="c3-community-page"><header class="community-header"><p>Teachers.Net Community</p><h1>' . esc_html($name) . '</h1><p>Recent conversations from teachers and education professionals.</p></header>' . $launcher . '<section aria-labelledby="activity-heading"><h2 id="activity-heading">Latest Activity</h2>';
            if (!$rows) {
