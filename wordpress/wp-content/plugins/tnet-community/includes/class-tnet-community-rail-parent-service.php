...
final class TNet_Community_Rail_Parent_Service {
    ...
    private static function icon(string $name): string {
        $paths = [
            ...
            'flame' => '<path d="M13.5 3.5c.4 3.2-1.4 4.3-2.5 5.7-.7-1.2-.9-2.2-.6-3.5C7.4 8 5.5 10.6 5.5 14a6.5 6.5 0 0 0 13 0c0-3.7-1.7-7-5-10.5z"/>',
            ...
            'settings' => '<circle cx="12" cy="12" r="3"/><path d="M19 13.5v-3l-2-.6a5.7 5.7 0 0 0-.7-1.6l1-1.8-2.1-2.1-1.8 1a5.7 5.7 0 0 0-1.6-.7L11.5 3h-3l-.6 2a5.7 5.7 0 0 0-1.6.7l-1.8-1-2.1 2.1 1 1.8a5.7 5.7 0 0 0-.7 1.6l-2 .6v3l2 .6a5.7 5.7 0 0 0 .7 1.6l-1 1.8 2.1 2.1 1.8-1a5.7 5.7 0 0 0 1.6.7l.6 2h3l.6-2a5.7 5.7 0 0 0 1.6-.7l1.8 1 2.1-2.1-1-1.8a5.7 5.7 0 0 0 .7-1.6z"/>',
        ];
