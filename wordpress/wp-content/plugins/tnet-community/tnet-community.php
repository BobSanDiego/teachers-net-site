...
require_once __DIR__ . '/includes/class-tnet-community-canonical-route.php';
...
require_once __DIR__ . '/includes/class-tnet-community-shared-shell.php';
...
require_once __DIR__ . '/includes/class-tnet-community-membership-repository.php';
...
add_action('template_redirect', static function (): void {
    ...
    ob_start(static function (string $html): string {
        // Runtime provenance remains in the response header. The former visual
        // badge was a local QA diagnostic and must not alter product geometry.
