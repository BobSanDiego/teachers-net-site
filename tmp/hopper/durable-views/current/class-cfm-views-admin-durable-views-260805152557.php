...
class CFM_Views_Admin
{
  ...
  private static function render_draft_editor(int $version_id): void
  {
    ...
    echo '</section><section class="cfm-views-composition" aria-labelledby="cfm-views-composition-title"><h3 id="cfm-views-composition-title">Current View <span class="description">(Editable draft)</span></h3>';
    echo '<div class="cfm-views-canvas-intro"><strong>Browse → Select → Add → Organize → Preview → Publish</strong><p class="description">Groups are containers; entries are the referenced Core Terms presented by this View. Published versions remain immutable.</p></div><h4>Groups <span class="description">(containers for entries)</span></h4><form method="post"><input type="hidden" name="cfm_views_action" value="save_group"><input type="hidden" name="version_id" value="' . esc_attr((string) $version_id) . '">';
    ...
    echo '<details id="cfm-views-add-entry" class="cfm-views-add-target"><summary>Alternate manual entry path</summary><p class="description">Use this compatibility path when you already know the canonical term. The Core Terms Library above is the recommended workflow.</p><form method="post" class="cfm-views-entry-form">';
    wp_nonce_field('cfm_views_save_entry', 'cfm_views_nonce');
  ...
  {
    echo '<style id="cfm-views-ia-styles">.cfm-views-editing-context{position:sticky;top:32px;z-index:5;display:flex;justify-content:space-between;gap:16px;align-items:center;background:#f6f7f7;border:1px solid #c3c4c7;border-left:4px solid #2271b1;padding:12px 16px;margin:16px 0}.cfm-views-editing-context h2{margin:2px 0}.cfm-views-editing-context p{margin:0}.cfm-views-add-target summary{cursor:pointer;font-weight:600}</style>';
