...
class CFM_Views_Admin
{
  ...
  private static function render_workbench_assets(): void
  {
    ...
    echo '<style id="cfm-views-dual-tree-styles">.cfm-views-tree-toolbar{display:flex;flex-wrap:wrap;gap:6px;align-items:center;padding:8px;background:#f6f7f7;border:1px solid #dcdcde;margin:8px 0 12px}.cfm-views-tree-toolbar .description{flex-basis:100%}.cfm-views-representation-state{font-size:11px;color:#646970;white-space:nowrap}.cfm-views-term-represented{background:#f0f6fc;box-shadow:inset 3px 0 #2271b1}.cfm-views-term-represented .cfm-views-representation-state{color:#135e96;font-weight:600}.cfm-views-current-tree>.cfm-views-group-card{margin-top:10px}.cfm-views-container-toggle{font-size:18px;text-decoration:none;line-height:1}.cfm-views-group-entries[hidden]{display:none}@media (max-width:900px){.cfm-views-representation-state{display:none}}</style>';
