# Job Center V1 Authority Program

Status: Frozen by DOC021
Scope: Minimum visual authority required for Job Center V1
...
5. Employer Operations
6. Employer Authoring
7. Saved Jobs
8. Job Alerts
...
program unless separately authorized.
...
No separate render is required for shared shell, individual lifecycle actions,
