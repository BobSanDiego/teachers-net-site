...
DOC017A. Responsive Design is complete; JC-030 is in bounded implementation
convergence under ADR001. Browser, accessibility, and human visual acceptance
remain the current gate; the manifest is not an implementation diary.
...
### JC-014 Mobile — Location Selection Modal Mobile Responsive Authority

- **Screen / Component:** Logged-out first-touch `/jobs/`, Location segment activated, modal open at the approved mobile presentation
- **Status:** Approved
- **Version:** 1.0
- **Approved Artifact:** `docs/job-center/design/approved/jc-014-location-selection-modal-mobile-v1.0.png`
- **Verified Source Raster:** `art/mockups/job-center/generated/jc014-mobile-responsive-r003-overlay-candidate.png`
- **Source dimensions:** `863 × 3756`
- **SHA-256:** `1956256109668a4ba36851edee85ba369c2854ed2142ab716d6fc5e1256e7efc`
- **Approval date:** 2026-07-14
- **Approval authority:** Engineering Director, DOC014
- **Approval scope:** Mobile presentation of JC-014 Location Selection Modal, including the full approved JC-010 Mobile page beneath the modal, subdued full-page backdrop, inset viewport-bound Location modal, Search by location heading, close control, Current Location / City, State, or ZIP / Browse by State tabs, current-location panel, distance control, cross-state checkbox, logged-out sign-in note, Cancel, disabled Apply, modal width, viewport position, hierarchy, reading rhythm, and preserved full-page context through the footer within the visible boundary.
- **Authority:** DOC014 explicitly approves the exact R003 overlay raster as the canonical JC-014 Mobile Responsive Authority.
- **Related Design System section:** 4, 8, 9, 12, 17
- **Related Product Specification:** Canonical V1 Contract
- **Related future UX Atlas entry:** JC-ATLAS-003, JC-ATLAS-012
- **Related implementation ticket(s):** None assigned
- **Notes:** The controlled-library copy is byte-identical to the verified repository candidate. JC-014 Desktop v1.0 remains the product/content authority and JC-010 Mobile v1.0 remains the shared underlying page-presentation authority. This approval changes only the backdrop and modal layer, is bounded to JC-014 Mobile, and does not alter tablet, desktop, implementation, or other screen authorities. Known implementation and accessibility guidance only: implement the modal as a localized overlay over the existing page, not as a reconstructed page; constrain modal height to the viewport; keep heading, close control, tabs, and action row reachable; allow internal modal-body scrolling where required; preserve focus containment while open; preserve Escape, Cancel, and close behavior without applying changes; ensure backdrop interaction does not dismiss; return focus to the Location trigger after dismissal; maintain compliant touch targets and visible focus indicators; and verify WCAG AA text and control contrast in browser rendering. Future JC-014 Mobile work is Patch Mode and requires a separately approved, explicitly named defect or delta.
...
### JC-015 Tablet — Browse Reveal Tablet Responsive Authority

- **Screen / Component:** Logged-out first-touch `/jobs/`, Browse by Grade or Subject expanded inline at the approved portrait-tablet presentation
- **Status:** Approved
- **Version:** 1.0
- **Approved Artifact:** `docs/job-center/design/approved/jc-015-browse-reveal-tablet-v1.0.png`
- **Verified Source Raster:** `art/mockups/job-center/generated/jc015-tablet-responsive-r003-clean-candidate.png`
- **Source SHA-256:** `4ae25357ebefc2f0620d64f0d6c6a88efd2bcd6805149f925969bda6560900d0`
- **Approval date:** 2026-07-14
- **Approval authority:** Engineering Director, DOC015
- **Approval scope:** Portrait-tablet presentation of JC-015 Browse Reveal, including the JC-010 tablet page beneath the Browse Reveal, Browse by Grade or Subject in the open state, five Browse cards in approved order, the 3+2 tablet card arrangement, Browse Reveal placement, spacing and hierarchy, and preserved listings, right rail, advertisements, pagination, and footer within the visible boundary.
- **Authority:** DOC015 explicitly approves the exact R003 cleaned raster as the canonical JC-015 Tablet Responsive Authority.
- **Related Design System section:** 4, 8, 9, 12, 17
- **Related Product Specification:** Canonical V1 Contract
- **Related implementation ticket(s):** None assigned
...
- **Status:** Approved
- **Version:** 1.3
- **Approved Artifact:** `docs/job-center/design/approved/jc-050-final-01a.png`
- **Authority:** Engineering Director, DESIGN-AUTHORITY008; final canonical Employer Operations All My Jobs desktop authority with JC-051. `jc-050-approved-candidate-01a.png`, JC-050 v1.1, and JC-050 v1.0 are retained as superseded historical evidence.
...
- **Related implementation ticket(s):** None assigned
- **Notes:** DESIGN-AUTHORITY008 supersedes the DESIGN-AUTHORITY007 candidate, JC-050 v1.1, and JC-050 v1.0 within the All My Jobs desktop visual boundary. My Jobs is the employer operating workspace; prior Dashboard concepts are absorbed into it and must not be revived as a separate V1 operating destination. This authority includes the official legacy Teachers.Net logo, floating application card, off-white browser/page surround, rounded outer card, restrained border and shadow, compact 60px flat-divider navbar with no elevated shadow, separator aligned to the 250px rail boundary, 250px neutral-gray desktop rail, 950px main workspace, outline briefcase treatment for All My Jobs, no total-job badge on All My Jobs, school rows without school icons, sparse operational alert badges, compact alert key, retained lower school illustration, compact My Jobs selector, filled blue Post a Job control, integrated filter/inventory panel, compact Order By control, aligned Action heading, widened overflow-action buttons, timeline alert icons for renewal-ready and expired states, red Expired label, regular-weight Draft labels, pagination, and privacy footer. The current mobile adaptation is recorded separately as Responsive Candidate / Implementation Target / Pending Browser Verification; it is not an Approved authority. JC-051 remains unchanged. Team Members functionality, bottom navigation, list/grid switching, archive behavior, notification workflow, Duplicate versus Repost terminology, and grace-period duration remain excluded or deferred. Future Employer Operations implementation is authorized only through a separate bounded ticket.
...
| `docs/job-center/design/approved/jc-050-employer-operations-all-my-jobs-desktop-v1.1.png` | Controlled JC-050 All My Jobs desktop v1.1 authority copy | Superseded | JC-050 | Retained as historical evidence after DESIGN-AUTHORITY007 and DESIGN-AUTHORITY008 |
| `docs/job-center/design/approved/jc-050-approved-candidate-01a.png` | Controlled JC-050 All My Jobs desktop replacement candidate | Superseded | JC-050 | DESIGN-AUTHORITY007; retained as historical evidence after DESIGN-AUTHORITY008; 1228 × 939; SHA-256 `47bb3555f36f8eef4968cf8b122061ef70a8bb2d7cdbfe9dcc848a0004b00a5f` |
| `/mnt/c/Main/Active/Projects/Teachers.Net/art/mockups/job center/jc-050-final-01a.png` | Engineering Director-approved JC-050 final source raster | Approved | JC-050 | DESIGN-AUTHORITY008 verified exact external source, 1228 × 937 dimensions, and SHA-256 `4404525b15f5b3640b000f9f6c936c73cba51f1626ff6905e55a9155dc3cb033` |
| `docs/job-center/design/approved/jc-050-final-01a.png` | Controlled JC-050 All My Jobs desktop final authority | Approved | JC-050 | Byte-identical to DESIGN-AUTHORITY008 source raster; canonical desktop authority for future Employer Operations All My Jobs convergence |
...
| `art/mockups/job-center/generated/jc014-mobile-responsive-r003-overlay-candidate.png` | Engineering Director-approved JC-014 Mobile source raster using localized overlay over full JC-010 Mobile page | Approved | JC-014 Mobile | DOC014 verified the exact repository candidate, dimensions, and SHA-256 |
| `docs/job-center/design/approved/jc-014-location-selection-modal-mobile-v1.0.png` | Controlled JC-014 Mobile v1.0 reference copy | Approved | JC-014 Mobile | Byte-identical to the DOC014-verified source raster; future work is Patch Mode |
