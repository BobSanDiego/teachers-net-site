# Community Natural Composer QA v1

PHP lint passed in DDEV for the composer controller and attachment model; `git diff --check` passed. Static contract checks confirmed the primary body, staged-content region, representative URL control, multipart image input, accepted MIME list, object-URL revocation, drag/drop handling, and removal of fixture selectors.
