...
The Markdown document is the source-faithful architecture and context record. The Word document is its strategic engineering approach and execution sequence. Both are planning artifacts; neither authorizes implementation, production changes, or migration.
