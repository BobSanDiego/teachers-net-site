...
foreach(['data-composer-view="shared-topic"','name="title"','id="body"'] as $needle) if(strpos($out,$needle)===false) exit(1);
if(strpos($out,'composer-formatting-help')!==false) exit(1);
